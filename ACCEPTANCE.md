...
| ⬜ | A voice approval appears in audit with `source='voice'` | Apply `sql/001_voice_audit.sql`, approve one low-risk queue item by voice, then `desk-action audit.recent`. |
